...
**Version: 0.1.8 — one click on the tray icon shows and hides the window.** DeskPort combines a viewer and optional host
...
See the [release notes](docs/RELEASE_0.1.8.md),

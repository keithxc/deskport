    ...
    QObject(parent)
{
    ...
    qDebug() << "Current DeskPort version:" << currentVersion;
...
{
    // DeskPort has an independent release channel. Never offer an upstream
    // Moonlight binary as an update for this development build.
}
